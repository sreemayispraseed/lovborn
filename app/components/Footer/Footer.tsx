...
const Footer = () => {
  return (
    <footer className="bg-[#FBECE3] text-gray-800 font-sans">
      {/* Top Section - Icons and Text */}
      <div className="border-b border-gray-200 py-8">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 ">
          <div className="flex flex-col items-center md:items-start">
            <div className="flex">
             <Image src={assets.shipping} alt="Free Shipping" width={24} height={24} className="h-6 w-6 text-orange-400"/>
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex">
             <Image src={assets.payment} alt="Free Shipping" width={24} height={24} className="h-6 w-6 text-orange-400"/>
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex">
             <Image src={assets.return_icon} alt="Free Shipping" width={24} height={24} className="h-6 w-6 text-orange-400"/>
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex">
             <Image src={assets.support} alt="Free Shipping" width={24} height={24} className="h-6 w-6 text-orange-400"/>
